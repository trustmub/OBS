...
ColReorder.prototype = {
	...
	"_fnMouseMove": function ( e )
	{
		...
		if ( this.dom.drag === null )
		{
			 ...
			 * point - this allows the user_view to make small mouse movements when sorting and not have a
	...
	/**
	 * Copy the TH element that is being drags so the user_view has the idea that they are actually
...
ColReorder.defaults = {
	...
	/**
	 * Redraw the table's column ordering as the end user_view draws the column
