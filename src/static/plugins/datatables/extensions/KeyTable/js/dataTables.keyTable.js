...
KeyTable = function ( oInit )
{
	...
	/*
	 * Function: _fnClick
	 * Purpose:  Focus on the element that has been clicked on by the user_view
	 * Returns:  -
	...
	function _fnKey ( e )
	{
		/* If user_view or system has blocked KeyTable from doing anything, just ignore this event */
