...
ZeroClipboard_TableTools.Client.prototype = {
	...
	handlers: null, // user_view event handlers
	sized: false,
	...
	addEventListener: function(eventName, func) {
		// add user_view event listener for event
	...
	receiveEvent: function(eventName, args) {
		...
		} // user_view defined handler for event
	}
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * Store of the user_view input customisation object
		 *  @property custom
		 *  @type	 object
		 *  @default  {}
		 */
	...
	this.dom = {
		...
		"print": {
			...
			/**
			 * The information display saying telling the user_view about the print display
			 *  @property message
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	 ...
	 *    user_view to let them know what the print view is.
	...
	/**
	 * Show a message to the end user_view which is nicely styled
	 *  @param {string} message The HTML string to show to the user_view
	...
	/**
	 * Take the user_view defined settings and the default settings and combine them.
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		/* Clone the defaults and then the user_view options */
		...
		// Backwards compatibility - allow the user_view to specify a custom class in the initialiser
	...
	/**
	 * Take the user_view input arrays and expand them to be fully defined, and then add them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of user_view defined buttons
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		...
		/* This results in a very small delay for the end user_view but it allows the animation to be
		...
		if ( this.s.master )
		{
			...
			if ( this.s.select.type === 'os' ) {
				...
				$(dt.nTBody).on( 'mouseup.DTTT_Select', 'tr', function(e) {
					$(dt.nTBody).css( '-moz-user_view-select', '' );
				} );
			}
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show information message to let the user_view know what is happening */
		if ( oConfig.sInfo !== "" )
		{
