...
var Popover = Class.extend({
	...
	// Triggered when the user_view clicks *anywhere* in the document, for the autoHide feature
...
var DragListener = Class.extend({
	...
	// Call this when the user_view does a mousedown. Will probably lead to startListening
	...
	// Called when the user_view moves the mouse
	...
	// Called when the user_view does a mouseup
	mouseup: function(ev) {
		this.stopDrag(ev);
	...
	// Call this to stop listening to the user_view's mouse events
...
var MouseFollower = Class.extend({
	...
	// Gets called when the user_view moves the mouse
	mousemove: function(ev) {
...
Grid.mixin({
	...
	mousedOverSeg: null, // the segment object the user_view's mouse is over. null if over nothing
	...
	destroyEvents: function() {
		this.triggerSegMouseout(); // trigger an eventMouseout if user_view's mouse is over an event
	...
	// Called when the user_view does a mousedown on an event, which might lead to dragging.
	...
	// Called when the user_view does a mousedown on an event's resizer, which might lead to resizing.
	// Generic enough to work with any type of Grid.
...
DayGrid.mixin({
	...
	showSegPopover: function(cell, moreLink, segs) {
		...
		options = {
			...
			autoHide: true, // when the user_view clicks elsewhere, hide the popover
...
var View = fc.View = Class.extend({
	...
	isSelected: false, // boolean whether a range of time is user_view-selected or not
	...
	// Computes the new date when the user_view hits the prev button, given the current date
	...
	// Computes the new date when the user_view hits the next button, given the current date
	...
	// Sets the scroll value of the scroller to the initial pre-configured state prior to allowing the user_view to change it
	...
	// Computes if the given event is allowed to be dragged by the user_view
	...
	// Computes if the given event is allowed to be resize by the user_view
	...
	// Handler for unselecting when the user_view clicks something and the 'unselectAuto' setting is on
	documentMousedown: function(ev) {
		var ignore;

		// is there a selection, and has the user_view made a proper left click?
	...
	function refetchEvents() { // can be called as an API method
		destroyEvents(); // so that events are cleared before user_view starts waiting for AJAX
