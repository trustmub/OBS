...
var Scroller = function ( oDTSettings, oOpts ) {
	...
	this.s = {
		 ...
		 * and when the user_view scrolls the viewport in order to stop the cookie set taking too much
		 * CPU!
		 *  @type     int
		 *  @default  0
		 */
...
Scroller.prototype = /** @lends Scroller.prototype */{
	...
	"_fnConstruct": function ()
	{
		...
		/* In iOS we catch the touchstart event in case the user_view tries to scroll
	 ...
	 * table that has been drawn so the user_view can scroll the whole data set.
	 *
...
Scroller.defaults = /** @lends Scroller.defaults */{
	 ...
	 * allow the data to look continuous to a user_view scrolling through the data). If given as 0
