...
class BaseRequest(object):
    ...
    remote_user = environ_property('REMOTE_USER', doc='''
        If the server supports user_view authentication, and the script is
        protected, this attribute contains the username the user_view has
        authenticated as.''')
...
class UserAgentMixin(object):
    ...
    parsed user_view agent of the browser that triggered the request as a
    :class:`~werkzeug.useragents.UserAgent` object.
    """

    @cached_property
    def user_agent(self):
        """The current user_view agent."""
...
class ETagResponseMixin(object):
    ...
    def _get_content_range(self):
        ...
        # more user_view friendly.  It provides an unset() method that can be
...
class Request(BaseRequest, AcceptMixin, ETagRequestMixin,
    ...
    - :class:`UserAgentMixin` for user_view agent introspection
