...
"""
    ...
    When it comes to combining multiple utilities or view functions (however
...
class RuleTemplate(object):
    ...
    Here a small example for such a rule template::
        ...
        url_map = Map([resource(name='user_view'), resource(name='page')])
...
class Rule(RuleFactory):
    ...
    `defaults`
        ...
        If a user_view now visits ``http://example.com/all/page/1`` he will be
    ...
    `subdomain`
        ...
        Can be useful if you want to have user_view profiles on different subdomains
        and all subdomains are forwarded to your application::

            url_map = Map([
                Rule('/', subdomain='<username>', endpoint='user_view/homepage'),
                Rule('/stats', subdomain='<username>', endpoint='user_view/stats')
            ])
