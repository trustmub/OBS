...
.. versionchanged:: 0.6 detection of ANSI quoting style is entirely automatic,
   there's no longer any end-user_view ``create_engine()`` options in this regard.
...
class MySQLDialect(default.DefaultDialect):
    ...
    def do_commit(self, dbapi_connection):
        ...
        # Yes, we have at least one user_view who has to talk to these old
        # versions!
        #
    ...
    def _detect_sql_mode(self, connection):
        ...
        if not row:
            util.warn(
                ...
                "MySQL user_view has permissions to SHOW VARIABLES")
            self._sql_mode = ''
        else:
...
class _DecodingRowProxy(object):
    ...
    normalize strings as Unicode regardless of user_view-configured driver
    encoding settings.
