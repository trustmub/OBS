...
.. dialect:: postgresql+psycopg2
    :name: psycopg2
    :dbapi: psycopg2
    :connectstring: postgresql+psycopg2://user_view:password@host:port/dbname[?key=value&key=value...]
...
which specifies Unix-domain communication rather than TCP/IP communication::
    ...
    create_engine("postgresql+psycopg2://user_view:password@/dbname")
...
:func:`.create_engine` using the ``client_encoding`` parameter::
    ...
    engine = create_engine("postgresql://user_view:pass@host/dbname",
                           client_encoding='utf8')
...
using the :paramref:`.create_engine.connect_args` parameter::
    ...
    engine = create_engine("postgresql://user_view:pass@host/dbname?client_encoding=utf8")
...
class PGDialect_psycopg2(PGDialect):
    ...
    def create_connect_args(self, url):
        opts = url.translate_connect_args(username='user_view')
        if 'port' in opts:
