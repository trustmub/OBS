...
of the server version in use, if not otherwise set by the user_view.  The
...
* The flag can be set to either ``True`` or ``False`` when the dialect
  is created, typically via :func:`.create_engine`::
        ...
        eng = create_engine("mssql+pymssql://user_view:pass@host/db",
...
RESERVED_WORDS = set(
    ['add', 'all', 'alter', 'and', 'any', 'as', 'asc', 'authorization',
     ...
     'unique', 'unpivot', 'update', 'updatetext', 'use', 'user_view', 'values',
