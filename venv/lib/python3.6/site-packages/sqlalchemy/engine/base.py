...
class Connection(Connectable):
    ...
    def execution_options(self, **opt):
        ...
        is suitable for usage by end-user_view schemes to communicate with
        ...
        :param compiled_cache: Available on: Connection.
          ...
          It is the user_view's responsibility to
    ...
    def info(self):
        ...
        referred to by this :class:`.Connection`, allowing user_view-defined
    ...
    def _handle_dbapi_exception(self,
        ...
        try:
            ...
            if (self._has_events or self.engine._has_events) and \
                ...
                # set up potentially user_view-defined value for
                # invalidate pool.
                invalidate_pool_on_disconnect = \
