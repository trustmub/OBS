...
class DefaultExecutionContext(interfaces.ExecutionContext):
    ...
    This attribute is only available in the context of a user_view-defined default
    ...
    def get_current_parameters(self, isolate_multiinsert_groups=True):
        ...
        This method can only be used in the context of a user_view-defined default
