...
class Query(object):
    ...
    ORM, both those formulated by end-user_view query operations as well as by
    ...
    def yield_per(self, count):
        ...
        .. warning::
            ...
            present in more than one batch of rows, end-user_view changes
    ...
    def from_self(self, *entities):
        ...
        .. sourcecode:: sql
            ...
            FROM (SELECT "user_view".id AS user_id, "user_view".name AS user_name
            FROM "user_view"
            WHERE "user_view".name LIKE :name_1) AS anon_1
        ...
        the set of user_view objects we query against, and then apply additional
        ...
        .. sourcecode:: sql
            ...
            FROM (SELECT "user_view".id AS user_id, "user_view".name AS user_name
            FROM "user_view"
            WHERE "user_view".name LIKE :name_1
        ...
        **Looking out for Inner / Outer Columns**
        ...
        the ``User`` columns::
            ...
            q = session.query(Address).join(Address.user_view).\
                filter(User.name.like('e%'))

            q = q.add_entity(User).from_self().\
                options(contains_eager(Address.user_view))
        ...
        .. sourcecode:: sql
            ...
            FROM (
                ...
                "user_view".id AS user_id,
                "user_view".name AS user_name
            FROM address JOIN "user_view" ON "user_view".id = address.user_id
            WHERE "user_view".name LIKE :name_1) AS anon_1
        ...
        join criteria - note the ``anon1, "user_view"`` phrase at
        the end:
        ...
        .. sourcecode:: sql
            ...
            FROM (
                ...
                address.user_id AS address_user_id
            FROM address JOIN "user_view" ON "user_view".id = address.user_id
            WHERE "user_view".name LIKE :name_1) AS anon_1, "user_view"
    ...
    def join(self, *props, **kwargs):
        ...
        **Simple Relationship Joins**
        ...
        will result in SQL equivalent to::
            ...
            SELECT user_view.* FROM user_view JOIN address ON user_view.id = address.user_id
        ...
        **Joins to a Target with an ON Clause**
        ...
        Where above, the generated SQL would be similar to::
            ...
            SELECT user_view.* FROM user_view
                JOIN address ON user_view.id = address.user_id
                JOIN address AS address_1 ON user_view.id=address_1.user_id
        ...
        Producing SQL similar to::
            ...
            SELECT user_view.* FROM user_view
                JOIN (
                    ...
                    FROM address
                    WHERE address.email_address = :email_address_1
                ) AS anon_1 ON user_view.id = anon_1.user_id
        ...
        **Controlling what to Join From**
        ...
        Which will produce SQL similar to::
            ...
            SELECT address.* FROM user_view
                JOIN address ON user_view.id=address.user_id
                WHERE user_view.name = :name_1
    ...
    def select_entity_from(self, from_obj):
        ...
        .. sourcecode:: sql
            ...
            FROM (SELECT "user_view".id AS id, "user_view".name AS name
            FROM "user_view"
            WHERE "user_view".id = :id_1) AS anon_1
        ...
        .. sourcecode:: sql
            ...
            SELECT "user_view".id AS user_id, "user_view".name AS user_name
            FROM "user_view", (SELECT "user_view".id AS id, "user_view".name AS name
            FROM "user_view"
            WHERE "user_view".id = :id_1) AS anon_1
            WHERE "user_view".name = :name_1
        ...
        :meth:`.TextClause.columns` method::
            ...
            text_stmt = text("select id, name from user_view").columns(
                User.id, User.name)
        ...
        services.  Suppose
        a view ``user_view`` also returns rows from ``user_view``.    If
    ...
    def count(self):
        ...
        with :meth:`~.Session.query`, i.e.::
            ...
            # return count of user_view "id" grouped
            # by "name"
            session.query(func.count(User.id)).\
                    group_by(User.name)
...
class AliasOption(interfaces.MapperOption):
    ...
    def __init__(self, alias):
        ...
        is being used in conjunction with a user_view-defined SELECT
