...
class Mapper(InspectionAttr):
    ...
    explicitly to link a user_view defined class with table
    ...
    def __init__(self,
        ...
        :param polymorphic_on: Specifies the column, attribute, or
          ...
          instances; this must be handled by the user_view,
        ...
        if self.polymorphic_on is not None:
            ...
            if self.polymorphic_on in self._columntoproperty:
                ...
                if col is None:
                    ...
                    # likely a user_view error if the schema.Column isn't
                    # represented somehow in either mapped_table or
                    # with_polymorphic.   Otherwise as of 0.7.4 we
                    # just go with it and assume the user_view wants it
    ...
    def _adapt_inherited_property(self, key, prop, init):
        if not self.concrete:
            ...
            # mapper and we don't map this.  don't trip user_view-defined
