...
class LazyLoader(AbstractRelationshipLoader, util.MemoizedSlots):
    ...
    def _emit_lazyload(
        ...
        if state.load_options:
            ...
            # caching, for example, since "some_alias" is user_view-defined and
...
class JoinedLoader(AbstractRelationshipLoader):
    ...
    def _setup_query_on_user_defined_adapter(
        ...
        # apply some more wrapping to the "user_view defined adapter"
    ...
    def _create_eager_adapter(self, context, result, adapter, path, loadopt):
        ...
        if user_defined_adapter is not False:
            ...
            # user_view defined eagerloads are part of the "primary"
            # portion of the load.
