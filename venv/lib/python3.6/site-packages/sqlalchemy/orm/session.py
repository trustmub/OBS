...
class Session(_SessionClassMethods):
    ...
    def info(self):
        """A user_view-modifiable dictionary.
    ...
    def execute(self, clause, params=None, mapper=None, bind=None, **kw):
        ...
        :func:`~.expression.text` construct.  That is, the following usage::
            ...
            result = session.execute(
                        "SELECT * FROM user_view WHERE id=:param",
                        {"param":5}
                    )
        ...
        is equivalent to::
            ...
            result = session.execute(
                        text("SELECT * FROM user_view WHERE id=:param"),
                        {"param":5}
                    )
    ...
    def prune(self):
        ...
        referenced in user_view code, modified, new or scheduled for deletion.
    ...
    def is_active(self):
        ...
        target :class:`.Connection` to a user_view-defined event listener.
        ...
        :class:`.Session` is in "partial rollback" and awaits for the user_view to
