...
instrumentation.py deals with registration of end-user_view classes
...
class ClassManager(dict):
    ...
    def _new_state_if_none(self, instance):
        ...
        if hasattr(instance, self.STATE_ATTR):
            ...
            # user_view error situation but allow the object
...
def _generate_init(class_, class_manager):
    ...
    # Go through some effort here and don't change the user_view's __init__
