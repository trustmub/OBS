...
This module is usually not directly visible to user_view applications, but
...
class QueryableAttribute(interfaces._MappedAttribute,
    ...
    def info(self):
        ...
        * If the attribute is a :class:`.ColumnProperty` but is mapped to
          ...
          attribute (which should be the case, unless a user_view-defined SQL
...
def create_proxied_attribute(descriptor):
    """Create an QueryableAttribute / user_view descriptor hybrid.
...
class CollectionAttributeImpl(AttributeImpl):
    ...
    InstrumentedCollectionAttribute holds an arbitrary, user_view-specified
    container object (defaulting to a list) and brokers access to the
    CollectionAdapter, a "view" onto that object that presents consistent bag
    semantics to the orm layer independent of the user_view data implementation.
