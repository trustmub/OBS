...
class MapperEvents(event.Events):
    ...
    * the :class:`.Mapper` class itself and the :func:`.mapper`
    ...
    user_view is encouraged to evaluate the
    :meth:`.SessionEvents.before_flush` and
    :meth:`.SessionEvents.after_flush` methods as more
    flexible and user_view-friendly hooks in which to apply
    ...
    :param raw=False: When True, the "target" argument passed
       ...
       instance's :class:`.InstanceState` management
       object, rather than the mapped instance itself.
    :param retval=False: when True, the user_view-defined event function
...
class AttributeEvents(event.Events):
    ...
    :param raw=False: When True, the "target" argument to the
      ...
      object, rather than the mapped instance itself.
    :param retval=False: when True, the user_view-defined event
