...
class ConnectionEvents(event.Events):
    ...
    :param retval=False: Applies to the :meth:`.before_execute` and
      ...
      user_view-defined event function must have a return value, which
    ...
    def handle_error(self, exception_context):
        ...
        * Establishing or disabling whether a connection or the owning
        ...
        the SQLAlchemy-constructed exception into one that is user_view
        ...
        .. warning::  Because the :meth:`.ConnectionEvents.handle_error`
           ...
           **stack traces will be misleading** if the user_view-defined event
