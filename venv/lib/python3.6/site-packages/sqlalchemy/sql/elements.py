...
def between(expr, lower_bound, upper_bound, symmetric=False):
    ...
    Would produce SQL resembling::
        ...
        SELECT id, name FROM user_view WHERE id BETWEEN :id_1 AND :id_2
...
class ClauseElement(Visitable):
    ...
    def self_group(self, against=None):
        ...
        :meth:`self_group` is automatic - end-user_view code should never
...
class ColumnElement(operators.ColumnOperators, ClauseElement):
    ...
    name that was user_view-assigned when producing a .label() construct.
...
class BindParameter(ColumnElement):
    ...
    def __init__(self, key, value=NO_ARG, type_=None,
        ...
        The above statement, when rendered, will produce SQL similar to::
            ...
            SELECT id, name FROM user_view WHERE name = :username
        ...
        We would see SQL logging output as::
            ...
            SELECT "user_view".id, "user_view".name
            FROM "user_view"
            WHERE "user_view".name = %(name_1)s
            {'name_1': 'Wendy'}
        ...
        The above will produce SQL output as::
            ...
            INSERT INTO "user_view" (name) VALUES (%(name)s)
            {'name': 'Wendy'}
...
class TextClause(Executable, ClauseElement):
    ...
    def bindparams(self, *binds, **names_to_values):
        ...
        Given a text construct such as::
            ...
            from sqlalchemy import text
            stmt = text("SELECT id, name FROM user_view WHERE name=:name "
...
class UnaryExpression(ColumnElement):
    ...
    def _create_nullsfirst(cls, column):
        ...
        The SQL expression from the above would resemble::
            ...
            SELECT id, name FROM user_view ORDER BY name DESC NULLS FIRST
    ...
    def _create_nullslast(cls, column):
        ...
        The SQL expression from the above would resemble::
            ...
            SELECT id, name FROM user_view ORDER BY name DESC NULLS LAST
    ...
    def _create_desc(cls, column):
        ...
        will produce SQL as::
            ...
            SELECT id, name FROM user_view ORDER BY name DESC
    ...
    def _create_asc(cls, column):
        ...
        will produce SQL as::
            ...
            SELECT id, name FROM user_view ORDER BY name ASC
    ...
    def _create_distinct(cls, expr):
        ...
        The above would produce an expression resembling::
            ...
            SELECT COUNT(DISTINCT name) FROM user_view
...
class ColumnClause(Immutable, ColumnElement):
    ...
    :func:`.column` function, as in::
        ...
        stmt = select([id, name]).select_from("user_view")
    ...
    def __init__(self, text, type_=None, is_literal=False, _selectable=None):
        ...
        a working table construct with minimal boilerplate::
            ...
            user_view = table("user_view",
                    column("id"),
                    column("name"),
                    column("description"),
            )

            stmt = select([user_view.c.description]).where(user_view.c.name == 'wendy')
