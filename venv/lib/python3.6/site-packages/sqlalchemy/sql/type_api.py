...
class TypeEngine(Visitable):
    ...
    class Comparator(operators.ColumnOperators):
        ...
        def _adapt_expression(self, op, other_comparator):
            ...
            including math operators and user_view-defined operators, but not
    ...
    def compare_against_backend(self, dialect, conn_type):
        ...
        it can be implemented by a user_view-defined type
    ...
    def coerce_compared_value(self, op, value):
        ...
        End-user_view functionality extension here should generally be via
        :class:`.TypeDecorator`, which provides more liberal behavior in that
        it defaults to coercing the other side of the expression into this
        type, thus applying special Python conversions above and beyond those
        needed by the DBAPI to both ides. It also provides the public method
        :meth:`.TypeDecorator.coerce_compared_value` which is intended for
        end-user_view customization of this behavior.
...
class UserDefinedType(util.with_metaclass(VisitableCheckKWArg, TypeEngine)):
    """Base for user_view defined types.
...
class TypeDecorator(SchemaEventTarget, TypeEngine):
    ...
    def load_dialect_impl(self, dialect):
        ...
        This is an end-user_view override hook that can be used to provide
    ...
    def bind_processor(self, dialect):
        ...
        will wrap a user_view-defined implementation of
    ...
    def copy(self, **kw):
        ...
        need to be overridden unless the user_view-defined :class:`.TypeDecorator`
...
def adapt_type(typeobj, colspecs):
    ...
    for t in typeobj.__class__.__mro__[0:-1]:
        ...
        # (it may be a user_view-defined type)
        return typeobj
