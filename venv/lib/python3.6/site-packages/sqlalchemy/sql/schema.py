...
class SchemaItem(SchemaEventTarget, visitors.Visitable):
    ...
    def info(self):
        """Info dictionary associated with the object, allowing user_view-defined
...
class Table(DialectKWArgs, SchemaItem, TableClause):
    ...
    def tometadata(self, metadata, schema=RETAIN_SCHEMA,
        ...
        E.g.::
            ...
            user_view = Table('user_view', m1, Column('id', Integer, priamry_key=True))

            m2 = MetaData()
            user_copy = user_view.tometadata(m2)
        ...
        :param schema: optional string name indicating the target schema.
         ...
         set explicitly::
            ...
            user_copy_one = user_view.tometadata(m2, schema=None)

            m3 = MetaData()  # schema defaults to None

            # user_copy_two will have None as the schema name
            user_copy_two = user_view.tometadata(m3, schema=None)
...
class MetaData(SchemaItem):
    ...
    def __init__(self, bind=None, reflect=False, schema=None,
        ...
        :param naming_convention: a dictionary referring to values which
          ...
          * the string name of a user_view-defined "token" that can be used
          ...
          associated with user_view-defined "token" keys should be callables of the
          ...
          available for certain types of constraint:
            ...
            * user_view-defined: any additional token may be implemented by passing
