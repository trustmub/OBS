...
asked to execute a construct in the absence of a user_view-defined transaction,
...
(i.e. convert to UTC upon user_view input, re-apply desired timezone upon display).
