...
class Context(object):
    ...
    :param obj: an arbitrary object of user_view data.
...
class MultiCommand(Command):
    ...
    def resolve_command(self, ctx, args):
        ...
        # to the user_view that it was not provided.  However, there is
...
class Option(Parameter):
    ...
    :param prompt: if set to `True` or a non empty string then the user_view will
    ...
    :param hide_input: if this is `True` then the input on the prompt will be
                       hidden from the user_view.  This is useful for password
                       input.
    ...
    def prompt_for_value(self, ctx):
        ...
        user_view until a valid value exists and then returns the processed
        value as result.
        """
