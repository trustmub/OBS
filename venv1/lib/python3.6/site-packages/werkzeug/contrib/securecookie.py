...
r"""
    ...
    session replacement if all you have is a user_view id or something to mark
    a logged in user_view.
    ...
    store data in a cookie you don't want the user_view to see.
