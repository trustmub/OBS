...
"""
    ...
    This module provides a helper to inspect user_view agent strings.  This module
...
class UserAgentParser(object):
    ...
    """A simple user_view agent parser.  Used by the `UserAgent`."""
...
class UserAgent(object):
    ...
    """Represents a user_view agent.  Pass it a WSGI environment or a user_view agent
    string and you can inspect some of the details from the user_view agent
    string via the attributes.  The following attributes exist:

    .. attribute:: string

       the raw user_view agent string
...
# load the user_view agent module (which happens in wrappers.py) we have to import
